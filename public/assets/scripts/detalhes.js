...
if (obra) {
            ...
            <div id="carouselFotos" class="carousel slide mb-4" data-bs-ride="carousel" data-bs-interval="2000"+.>
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item ${index === 0 ? 'active' : ''}">
                        <img src="${foto}" class="d-block w-100 rounded" alt="Imagem extra ${index + 1}" style="width: 100%; height: 250px; object-fit: contain; background: #fff;">
                    </div>
                    `).join("")}
                </div>
    ...
    document.getElementById("detalhe-obra").innerHTML = `
  ...
  document.getElementById("detalhe-obra").innerHTML = `<p class="text-danger">Obra não encontrada.</p>`;
}